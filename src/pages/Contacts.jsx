        ...
        <div className={styles.contactsAndLocation}>
          <div className={styles.mapAndText}>
            <div className={styles.map}>
              <iframe
                src="https://yandex.by/map-widget/v1/?ll=27.505479%2C53.864554&mode=search&ol=geo&ouri=ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgg2NjY3MjI0MxJU0JHQtdC70LDRgNGD0YHRjCwg0JzRltC90YHQuiwg0LfQsNCy0YPQu9Cw0Log0KHQvtGEJ9GWINCa0LDQstCw0LvQtdGe0YHQutCw0LksIDU00LoxIgoNOAvcQRVOdVdC&z=17.3&theme=dark"
                title="Карта"
              />
            </div>
          ...
          <div className={styles.backgroundContacts}>
            <img src={bgContacts} alt="" className={styles.bg} />
            ...
            <div className={styles.backgroundContactsText}>
              <h1>
                Для расчёта индивидуальных условий<br className={styles.brmobile}/> доставки, пожалуйста,<br className={styles.br}/>
